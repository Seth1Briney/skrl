...
class PrioritizedMemory(Memory):
    ...
    def sample(self,
        ...
        """Sample a batch from memory with prioritization
        ...
        if self._replacement:
            indexes = torch.multinomial(p, batch_size, replacement=True)
        else:
            ...
            indexes = torch.multinomial(p, batch_size, replacement=False)
